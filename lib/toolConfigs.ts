...
const passportVariants: ToolVariant[] = [
  ...
  { slug: 'ibps-exam', label: 'IBPS Exam', metaTitle: 'IBPS Exam Photo Resize Online Free (20KB-50KB) | SizeSnap', metaDescription: 'Format your passport photo for IBPS Bank Clerk & PO application form. 20-50KB.', h1: 'IBPS Exam Photo Resizer', introParagraph: 'Crop and scale your passport photo to meet strict IBPS requirements (20KB to 50KB).', config: { width: 413, height: 531, maxKB: 50 } }
];
...
const signatureVariants: ToolVariant[] = [
  ...
  { slug: 'neet-signature', label: 'NEET Sign', metaTitle: 'Resize Signature for NEET Exam Online Free (4-30KB) | SizeSnap', metaDescription: 'Resize and compress your signature scan under 30KB for NEET application form online.', h1: 'NEET Exam Signature Resizer', introParagraph: 'Scale your signature image perfectly for NEET application guidelines (4KB to 30KB limit).', config: { maxKB: 30 } },
  { slug: 'jee-signature', label: 'JEE Sign', metaTitle: 'Resize Signature for JEE Main Exam Online Free (4-30KB) | SizeSnap', metaDescription: 'Resize and compress your signature scan under 30KB for JEE Main registration online.', h1: 'JEE Main Signature Resizer', introParagraph: 'Scale your signature image perfectly for JEE registration guidelines (4KB to 30KB limit).', config: { maxKB: 30 } }
];
