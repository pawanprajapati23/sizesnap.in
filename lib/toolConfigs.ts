...
const passportVariants: ToolVariant[] = [
  ...
  { slug: 'rrb-ntpc', label: 'RRB NTPC / Group D / ALP', metaTitle: 'RRB NTPC Exam Photo Resizer Online Free (20KB-50KB) | SizeSnap', metaDescription: 'Resize and crop passport photo for Railway RRB NTPC, Group D, and ALP exam online. Matches standard 3.5x4.5cm and 20KB-50KB guidelines.', h1: 'RRB NTPC Exam Photo Resizer', introParagraph: 'Dedicated Railway resizer tool for RRB NTPC, Group D, and ALP candidates to resize photo under the mandatory 20KB-50KB limit.', config: { width: 413, height: 531, maxKB: 50 } },
...
const signatureVariants: ToolVariant[] = [
  ...
  { slug: 'rrb-signature', label: 'RRB NTPC Sign', metaTitle: 'Resize Signature for Railway RRB NTPC Exam (10-20KB) | SizeSnap', metaDescription: 'Resize and compress your signature scan under 20KB for Railway RRB NTPC, Group D, and ALP online. Meets standard 10KB to 20KB limit.', h1: 'RRB NTPC Signature Resizer', introParagraph: 'Crop and compress your scanned signature to exactly 10KB-20KB for the Railway RRB exam application.', config: { width: 140, height: 60, maxKB: 20 } },
