...
const MAPPINGS = [
  ...
  { pretty: '/compress-pdf-to-400kb', raw: '/compress-pdf/to-400kb' },
  { pretty: '/compress-pdf-to-500kb', raw: '/compress-pdf/to-500kb' },
  { pretty: '/compress-pdf-to-custom-size', raw: '/compress-pdf/custom-size' },
  { pretty: '/compress-pdf-to-custom-size', raw: '/compress-pdf/custom-size' },
  ...
  { pretty: '/ssc-cgl-exam-photo-maker', raw: '/exam-pack-generator/ssc-cgl-exam-pack' },
  { pretty: '/neet-ug-exam-photo-maker', raw: '/exam-pack-generator/neet-ug-exam-pack' },
  { pretty: '/upsc-exam-photo-maker', raw: '/exam-pack-generator/upsc-ias-exam-pack' },
  { pretty: '/ibps-po-exam-photo-maker', raw: '/exam-pack-generator/ibps-po-exam-pack' },
  { pretty: '/up-police-exam-photo-maker', raw: '/exam-pack-generator/up-police-exam-pack' },
  { pretty: '/rrb-ntpc-exam-photo-maker', raw: '/exam-pack-generator/rrb-ntpc-exam-pack' },
  { pretty: '/ctet-exam-photo-maker', raw: '/exam-pack-generator/ctet-exam-pack' },
  { pretty: '/indian-army-agniveer-photo-maker', raw: '/exam-pack-generator/agniveer-exam-pack' },
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://www.googletagmanager.com https://*.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://pagead2.googlesyndication.com https://*.googlesyndication.com https://*.doubleclick.net https://cdn.ampproject.org https://adservice.google.com https://*.highperformanceformat.com https://*.effectivecpmnetwork.com; worker-src 'self' blob: https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.ampproject.org; img-src 'self' blob: data: https://* http://*; font-src 'self' https://fonts.gstatic.com; connect-src 'self' blob: https://cdn.jsdelivr.net https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://analytics.google.com https://pagead2.googlesyndication.com https://*.googlesyndication.com https://*.doubleclick.net https://*.googletagmanager.com https://www.googletagmanager.com https://adservice.google.com https://*.highperformanceformat.com https://*.effectivecpmnetwork.com https://*.googleapis.com https://*.google.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com wss://*.firebaseio.com https://*.firebaseio.com; frame-src 'self' https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://www.google.com https://*.google.com https://* http://*; object-src 'none';",
          }
        ]
      },
      {
